<div>
    <h2 class="text-3xl font-bold mb-5">Editer {{$model['name']}}</h2>
    <form wire:submit.prevent="editFund" class="flex flex-col gap-3">
        ...
        <div class="flex justify-end">
            <x-main-button>Sauvegarder</x-main-button>
        </div>
    </form>
</div>
